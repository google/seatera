...
class NegativeKeywordsUploader(Mutator):
    def __init__(self, client, customer_id):
        ...
        self._ad_group_criterion_service = client.get_service("AdGroupCriterionService")
    ...
    def upload_from_script(self, keywords):
            ...
            for kw, adgroups in keywords.items():
                for ag_id in adgroups:
                    # Create keyword.
                    ad_group_criterion_operation = self._client.get_type("AdGroupCriterionOperation")
